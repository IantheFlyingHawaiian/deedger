...
public class GameRenderer {
    ...
    // Game Assets
    private TextureRegion bg, grass, deegMid, skullUp, skullDown, bar, ready,
    ...
    private void drawDeegCentered(float runTime) {
